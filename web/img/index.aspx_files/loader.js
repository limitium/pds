...
loader.supportFlash = function ()
{
    ...
    return true;
        ...
        loader.updateDownload = function ()
        {
            ...
            p *= TOD_ScriptPercent;
            document.getElementById("progressBar").style.width = (p * 508).toString() + "px";
        ...
        loader.removeSplash = function ()
        {
            window.clearInterval(loader.updateInterval);

            var element = document.getElementById("soundctrl");
        ...
        loader.setProgressbar = function (value)
        {
            var element = document.getElementById("progressBar");

            if (element)
                element.style.width = (value * 508).toString() + "px";
        }
        ...
        window.onload = function ()
        {
            ...
            {
/* Not for CB               if (loader.supportFlash())
                {
                    var elem = document.createElement("script");
                    elem.charset = "utf-8";
